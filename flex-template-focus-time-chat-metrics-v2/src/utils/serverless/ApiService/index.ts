...
export default abstract class ApiService {
  ...
  constructor() {
    ...
    // use serverless_functions_domain_focus_time_chat_metrics_v2 from ui_attributes, or .env or set as undefined
    ...
    if (custom_data?.serverless_functions_domain_focus_time_chat_metrics_v2)
      this.serverlessDomain = custom_data.serverless_functions_domain_focus_time_chat_metrics_v2;
    ...
    if (!this.serverlessDomain)
      console.error(
        "serverless_functions_domain_focus_time_chat_metrics_v2 is not set in flex config or env file"
      );
  }
