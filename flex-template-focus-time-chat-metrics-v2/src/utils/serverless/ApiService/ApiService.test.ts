...
describe('utils/common/ApiService', () => {
  ...
  it('should provide access to the configured serverless domain', () => {
    ...
    const { serverless_functions_domain_focus_time_chat_metrics_v2 } = ui_attributes as UIAttributes;
    expect(TestService.serverlessDomain).toBe(serverless_functions_domain_focus_time_chat_metrics_v2);
  });
